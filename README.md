1. Replace `<your_account>` with your Github username in the link
   - [DEMO LINK](https://misha-vynnyk.github.io/js_task_parse_list_DOM/)
2. Follow [this instructions](https://mate-academy.github.io/layout_task-guideline/)
   - Run `npm run test` command to test your code;
   - Run `npm run test:only -- -n` to run a fast test ignoring linter;
   - Run `npm run test:only -- -l` to run a fast test with additional info in the console ignoring linter.

### Task: Parse list with data attributes

Hey there! Can you parse data from the list and sort it based on data attributes?

Your task: Sort the list by salary in descending order.
