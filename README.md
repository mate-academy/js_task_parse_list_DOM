1. Replace `<your_account>` with your Github username in the link
   DONE - [DEMO LINK](https://manankin.github.io/js_task_parse_list_DOM/)
...
DONE - first, which sorts the list by salary from data attributes
DONE - second, which returns an array of objects, where objects are employees.
